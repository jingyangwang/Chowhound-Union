...
public class BusinessInformation_gbjd extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.businesse_information_gbjd
				);
	...
	OnClickListener listener=new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			case R.id.dianping:
				...
				Intent intent1=new Intent(getApplicationContext(),Gbjd_spoken.class);
				intent1.putExtra("MER_NAME", "宫保鸡丁");
			...
			case R.id.shoucang:
				...
				Intent intent0=new Intent(getApplicationContext(),Gbjd_Send.class);
				intent0.putExtra("MER_NAME", "宫保鸡丁");
					//startActivity(swIntent);
...
//
//				  Toast.makeText(BusinessInformation_gbjd.this, "你已经成功收藏此菜谱，加油，美食无尽头",
...
//				startActivity(intent);
			...
			case R.id.fenxiang:
				 Intent intent=new Intent(Intent.ACTION_SEND);
			      ...
			      intent.putExtra(Intent.EXTRA_TEXT, "宫保鸡丁这道菜的最大特点就是把鸡肉切成很多小块，每块一口就能吞下去，真是一种新奇而有趣的吃法(分享自吃货联盟)");
			      startActivity(Intent.createChooser(intent, "分享自己爱的美食"));
			      Toast.makeText(BusinessInformation_gbjd.this, "分享自己喜欢的美味，是一种人生的姿态",
						     Toast.LENGTH_LONG).show();
				break;
...
//				Intent intent=new Intent(getApplicationContext(),Xx.class);
//				startActivity(intent);
			    Toast.makeText(BusinessInformation_gbjd.this, "你已经成功点赞哦",
					     Toast.LENGTH_LONG).show();
				break;
