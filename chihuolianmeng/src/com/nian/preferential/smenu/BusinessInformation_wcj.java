...
import com.spoken.wcj_Send;
import com.spoken.wcj_spoken;

public class BusinessInformation_wcj extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.businesse_information_wcjl);
	...
	OnClickListener listener=new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			case R.id.dianping:
				...
				Intent intent0=new Intent(getApplicationContext(),wcj_spoken.class);
				intent0.putExtra("MER_NAME", "文昌鸡");
			...
			case R.id.shoucang:
				...
				Intent intent1=new Intent(getApplicationContext(),wcj_Send.class);
				intent1.putExtra("MER_NAME", "文昌鸡");
					//startActivity(swIntent);
				startActivity(intent1);
				
				
				
//				  Toast.makeText(BusinessInformation_wcj.this, "你已经成功收藏此菜谱，加油，美食无尽头",
...
//				startActivity(intent);
			...
			case R.id.fenxiang:
				 Intent intent=new Intent(Intent.ACTION_SEND);
			      ...
			      Toast.makeText(BusinessInformation_wcj.this, "分享自己喜欢的美味，是一种人生的姿态",
						     Toast.LENGTH_LONG).show();
				break;
...
//				Intent intent=new Intent(getApplicationContext(),Xx.class);
//				startActivity(intent);
			    Toast.makeText(BusinessInformation_wcj.this, "你已经成功点赞哦",
					     Toast.LENGTH_LONG).show();
				break;
