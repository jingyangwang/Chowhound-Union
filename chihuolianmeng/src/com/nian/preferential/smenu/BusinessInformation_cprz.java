...
import com.spoken.Btxl_Send;
import com.spoken.Btxl_spoken;
import com.spoken.Cprz_Send;
import com.spoken.Cprz_spoken;

public class BusinessInformation_cprz extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.businesse_information_cprz);
	...
	OnClickListener listener=new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			case R.id.dianping:
				...
				Intent intent0=new Intent(getApplicationContext(),Cprz_spoken.class);
				intent0.putExtra("MER_NAME", "脆皮乳猪");
			...
			break;
			case R.id.shoucang:
				Intent intent1=new Intent(getApplicationContext(),Cprz_Send.class);
				intent1.putExtra("MER_NAME", "脆皮乳猪");
					//startActivity(swIntent);
				startActivity(intent1);
//				  Toast.makeText(BusinessInformation_cprz.this, "你已经成功收藏此菜谱，加油，美食无尽头",
...
//				startActivity(intent);
			...
			case R.id.fenxiang:
				 Intent intent=new Intent(Intent.ACTION_SEND);
			      ...
			      intent.putExtra(Intent.EXTRA_TEXT, "脆皮乳猪唇齿留香，肥而不腻，你想试试吗!(分享自吃货联盟)");
			      startActivity(Intent.createChooser(intent, "分享自己爱的美食"));
			      Toast.makeText(BusinessInformation_cprz.this, "分享自己喜欢的美味，是一种人生的姿态",
						     Toast.LENGTH_LONG).show();
				break;
...
//				Intent intent=new Intent(getApplicationContext(),Xx.class);
//				startActivity(intent);
			    Toast.makeText(BusinessInformation_cprz.this, "你已经成功点赞哦",
					     Toast.LENGTH_LONG).show();
				break;
	...
	private void initResourceRefs() {
		...
		view = inflater.inflate(R.layout.bus_info_windows_cprz, null);
