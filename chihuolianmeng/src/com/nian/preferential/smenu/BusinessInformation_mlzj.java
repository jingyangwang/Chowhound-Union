...
import com.spoken.Mlzj_Send;
import com.spoken.Mlzj_spoken;

public class BusinessInformation_mlzj extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.businesse_information_mlzj);
...
OnClickListener listener=new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			case R.id.dianping:
				...
				Intent intent0=new Intent(getApplicationContext(),Mlzj_spoken.class);
				intent0.putExtra("MER_NAME", "麻辣子鸡");
			...
			break;
			case R.id.shoucang:
				Intent intent1=new Intent(getApplicationContext(),Mlzj_Send.class);
				intent1.putExtra("MER_NAME", "麻辣子鸡");
					//startActivity(swIntent);
				startActivity(intent1);
//				  Toast.makeText(BusinessInformation_mlzj.this, "你已经成功收藏此菜谱，加油，美食无尽头",
...
//				startActivity(intent);
			...
			case R.id.fenxiang:
				 Intent intent=new Intent(Intent.ACTION_SEND);
			      ...
			      intent.putExtra(Intent.EXTRA_TEXT, "“麻辣子鸡”这道菜，是湖南长沙百年老店“玉楼东”的看家名菜(分享自吃货联盟)");
			      startActivity(Intent.createChooser(intent, "分享自己爱的美食"));
			      Toast.makeText(BusinessInformation_mlzj.this, "分享自己喜欢的美味，是一种人生的姿态",
						     Toast.LENGTH_LONG).show();
				break;
...
//				Intent intent=new Intent(getApplicationContext(),Xx.class);
//				startActivity(intent);
			    Toast.makeText(BusinessInformation_mlzj.this, "你已经成功点赞哦",
					     Toast.LENGTH_LONG).show();
				break;
