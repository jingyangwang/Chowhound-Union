	...
	public void initSetting() {
		...
		showList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				switch (arg2) {
				case 0:
					 swIntent = new Intent(Market.this , PoiSerch.class);//附近商场
					
						bundle.putString("MyString", "商场");  
						swIntent.putExtras(bundle);  
						
					break;
				case 1:
					 swIntent = new Intent(Market.this , PoiSerch.class);//酒店
				...
				case 2:
					...
					break;
				case 3:
					 swIntent = new Intent(Market.this , PoiSerch.class);//房地产
					 bundle.putString("MyString", "房产销售中心");  
						swIntent.putExtras(bundle);  
					break;
				
				case 4:
					 swIntent = new Intent(Market.this , PoiSerch.class);//公园
					 bundle.putString("MyString", "公园");  
						swIntent.putExtras(bundle);  
					break;
					
				case 5:
					 swIntent = new Intent(Market.this , PoiSerch.class);//广场
					 bundle.putString("MyString", "广场");  
						swIntent.putExtras(bundle);  
					break;
				case 6:
					 swIntent = new Intent(Market.this , PoiSerch.class);//酒吧
					 bundle.putString("MyString", "酒吧");  
						swIntent.putExtras(bundle);  
					break;
				case 7:
					 swIntent = new Intent(Market.this , PoiSerch.class);//学校
					 bundle.putString("MyString", "学校");  
						swIntent.putExtras(bundle);  
					break;
				case 8:
					 swIntent = new Intent(Market.this , PoiSerch.class);//医院
					 bundle.putString("MyString", "医院");  
						swIntent.putExtras(bundle);  
					break;
				case 9:
					 swIntent = new Intent(Market.this , PoiSerch.class);//政府机关
					 bundle.putString("MyString", "政府");  
						swIntent.putExtras(bundle);  
					break;
	...
	public class NearAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView,ViewGroup parent) {
			...
			if (convertView == null) {
				...
				if(position==0){hold.name.setText("附近商场");
				hold.local.setText("购物");
				hold.dis1.setText("2000米内");
				//hold.dis2.setText(""); 
				//hold.dis3.setText("");
				}
				else if(position==1){hold.name.setText("酒店");
				hold.local.setText("住宿");
				hold.dis1.setText("2000米内");
				//hold.dis2.setText(""); 
				//hold.dis3.setText("");
				}
				...
				else if(position==3){hold.name.setText("房地产");
				hold.local.setText("住宅");
				hold.dis1.setText("2000米内");
//				hold.dis2.setText(""); 
//				hold.dis3.setText("");
				}
				else if(position==4){hold.name.setText("公园");
				hold.local.setText("休闲");
				hold.dis1.setText("2000米内");
//				hold.dis2.setText(""); 
//				hold.dis3.setText("");
				}
//				else if(position==5){hold.name.setText("广场");
//				hold.local.setText("休闲");
//				hold.dis1.setText("2000米内");
////				hold.dis2.setText(""); 
////				hold.dis3.setText("");
//				}
//				else if(position==6){hold.name.setText("酒吧");
//				hold.local.setText("娱乐");
//				hold.dis1.setText("2000米内");
////				hold.dis2.setText(""); 
////				hold.dis3.setText("");
...
//				
//				
//				else if(position==7){hold.name.setText("学校");
//				hold.local.setText("教育");
//				hold.dis1.setText("2000米内");
////				hold.dis2.setText(""); 
////				hold.dis3.setText("");
//				
//				}
//				
//				else if(position==8){hold.name.setText("医院");
...
//				}
//				
//				else if(position==9){hold.name.setText("政府机关");
//				hold.local.setText("党政部门");
//				hold.dis1.setText("2000米内");
////				hold.dis2.setText(""); 
////				hold.dis3.setText("");
//				
