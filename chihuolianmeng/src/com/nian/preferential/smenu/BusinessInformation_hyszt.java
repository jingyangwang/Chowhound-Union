...
import com.spoken.Gbjd_Send;
import com.spoken.Gbjd_spoken;
import com.spoken.Hyszt_Send;
import com.spoken.Hyszt_spoken;

public class BusinessInformation_hyszt extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.businesse_information_hyszt
				);
...
OnClickListener listener=new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			case R.id.dianping:
				...
				Intent intent1=new Intent(getApplicationContext(),Hyszt_spoken.class);
				intent1.putExtra("MER_NAME", "淮扬狮子头");
			...
			break;
			case R.id.shoucang:
				Intent intent0=new Intent(getApplicationContext(),Hyszt_Send.class);
				intent0.putExtra("MER_NAME", "淮扬狮子头");
					//startActivity(swIntent);
				startActivity(intent0);	
//				  Toast.makeText(BusinessInformation_hyszt.this, "你已经成功收藏此菜谱，加油，美食无尽头",
...
//				startActivity(intent);
			...
			case R.id.fenxiang:
				 Intent intent=new Intent(Intent.ACTION_SEND);
			      ...
			      intent.putExtra(Intent.EXTRA_TEXT, "淮扬狮子头应该是肉香醇厚与清鲜怡人两者兼备，但这其中绝无半分油、酱、糖、酒之类的粉黛气。(分享自吃货联盟)");
			      startActivity(Intent.createChooser(intent, "分享自己爱的美食"));
			      Toast.makeText(BusinessInformation_hyszt.this, "分享自己喜欢的美味，是一种人生的姿态",
						     Toast.LENGTH_LONG).show();
				break;
...
//				Intent intent=new Intent(getApplicationContext(),Xx.class);
//				startActivity(intent);
			    Toast.makeText(BusinessInformation_hyszt.this, "你已经成功点赞哦",
					     Toast.LENGTH_LONG).show();
				break;
