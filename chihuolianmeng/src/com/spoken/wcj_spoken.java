...
public class wcj_spoken extends Activity {
...
private static final String AWAY_DATE[] = {  "最热门", "新发布" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wcj_spoken);
		...
		new AsyncTask<String, Void, ArrayList>() {
			...
			protected void onPostExecute(ArrayList result) {
				...
				simpleAdapter = new SimpleAdapter(wcj_spoken.this, listmap, R.layout.nearby_list_item,
...
//							init(convertView);
		...
		}.execute("http://115.28.233.97/chlm/index.php/Home/Index/pl/fid/10");
