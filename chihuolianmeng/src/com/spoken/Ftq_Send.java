...
public class Ftq_Send extends Activity {
...
private static final String AWAY_DATE[] = {  "最热门", "新发布" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ftq_send);
		...
		findViewById(R.id.button1).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				readNet("http://115.28.233.97/chlm/index.php/Home/Index/insert/inser/3,,,,,"+et.getText());
			}
		});
...
//				text.setText("发送成功");
				Toast.makeText(Ftq_Send.this, "发送成功",Toast.LENGTH_LONG).show();
			}
